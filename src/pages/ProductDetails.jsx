       ...
       <Container>
         ...
         <div  className='w-[100%] lg:w-[40%] pt-8 lg:pt-0'>
            ...
            <div className='flex gap-4 items-center pt-[10px] lg:pt-[20px] pb-[10px] lg:pb-[20px]'>
               ...
               <div className='h-[20px] w-[20px] hover:h-[30px] hover:w-[30px]  rounded-full bg-[rgba(0,0,0,0.27)] cursor-pointer'></div>
               <div className='h-[20px] w-[20px] hover:h-[30px] hover:w-[30px] rounded-full bg-[#FF8686] cursor-pointer'></div>
               <div className='h-[20px] w-[20px] hover:h-[30px] hover:w-[30px] rounded-full bg-[#7ED321] cursor-pointer'></div>
               <div className='h-[20px]  w-[20px] hover:h-[30px] hover:w-[30px] rounded-full bg-[#B6B6B6] cursor-pointer'></div>
               <div className='h-[20px] w-[20px] hover:h-[30px] hover:w-[30px] rounded-full bg-[#15CBA5] cursor-pointer'></div>
            </div> <hr />
