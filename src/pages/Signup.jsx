  ...
  return (
    <div className='py-[48px]'>
      ...
      <div className="flex items-center justify-start flex-wrap pt-[42px] gap-x-8">
        ...
        <input type="text"  class=" lg:w-[100%]  border-1 border-[#FFFFFF]  outline-1    h-[40px] w-[400px] "  maxlength="300" name="inputData"   placeholder='Last Name'></input> 
        </div>
      ...
      <div className="flex items-center justify-start flex-wrap pt-[42px] gap-x-8">
        ...
        <input type="tel"  class=" lg:w-[100%]  border-1 border-[#FFFFFF]  outline-1    h-[40px] w-[400px]  "  maxlength="300" name="inputData"   placeholder='Your phone number'></input> 
        </div>
      ...
      <div className="flex items-center justify-start flex-wrap pt-[42px] gap-x-8">
        ...
        <input type="text"  class=" lg:w-[100%]  border-1 border-[#FFFFFF]  outline-1    h-[40px] w-[400px]  "  maxlength="300" name="inputData"   placeholder='—'></input> 
        </div>
      ...
      <div className="flex items-center justify-start flex-wrap pt-[42px] gap-x-8">
        <div className=""> 
         ...
         <input type="text"  class=" lg:w-[100%] h-[40px] w-[400px] border-1 border-[#FFFFFF]  outline-1     "  maxlength="300" name="inputData"   placeholder='Your city'/> <hr />
         </div>
        <div className=" ">
   ...
   <select id="cars" name="district" form="districtform" className='ml-4 font-dm text-[15px] font-bold text-gr leading-[18.23px] '   >
    ...
    <option value="Comilla">Rangpur</option>
      ...
      <div className="flex items-center justify-start flex-wrap pt-[42px] gap-x-8">
        ...
        <input type="password"  class=" lg:w-[100%]  border-1 border-[#FFFFFF]  outline-1    h-[40px] w-[400px]  "  maxlength="300" name="inputData"   placeholder='Repeat password'></input> 
        </div>
      </div>
      </div>
      ...
      <div className="pt-4 flex items-center justify-start flex-wrap gap-x-3">
        <p className='font-dm text-[14px] font-normal text-gr leading-[18.23px]'>Subscribe Newsletter</p>
        <input type="checkbox"></input>
